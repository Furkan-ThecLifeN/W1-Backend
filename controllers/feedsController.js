...
  const { postText, mediaUrl, ownershipAccepted, images, privacy } = req.body; // ✅ 'content' yerine 'postText' olarak değiştirildi
...
      text: postText || "", // ✅ 'postText' kullanıldı
      content: postText || "", // ✅ 'postText' kullanıldı
      mediaUrl: embedUrl,
